...
if (isset($_POST["add_news"])) {
    ...
    $folder = "images/news/" . $encryptedProfileLink . "." . $extension;
    ...
    if (empty($title)) {
        ...
        $stmt = mysqli_prepare($conn, "INSERT INTO `news` (`user_id`,`title`, `description`, `date`,`image`) VALUES (?,?, ?, ?,?)");
        ...
        if ($stmt) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                if (!$file_error > 0) {
                    ...
                    header("location:news.php?success=true");
                }
            ...
            <section>
                <div class="menu">
                    ...
                    <div class="menu-content ">
                        ...
                        <div class="menu-item active" onclick="window.location.href ='news.php'">

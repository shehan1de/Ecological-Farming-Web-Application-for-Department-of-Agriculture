...
if (isset($_POST["add_consulting"])) {
    ...
    $folder = "images/consulting/" . $encryptedProfileLink . "." . $extension;
    ...
    if (empty($title)) {
        ...
        $stmt = mysqli_prepare($conn, "INSERT INTO `consulting` (`user_id`,`title`, `description`, `date`,`image`) VALUES (?,?, ?, ?,?)");
        ...
        if ($stmt) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                if (!$file_error > 0) {
                    ...
                    header("location:consulting.php?success=true");
                }
            ...
            <section>
                ...
                <div class="menu-header ">
                    ...
                    <div class="menu-content ">
                        ...
                        <div class="menu-item active" onclick="window.location.href ='consulting.php'">
                        ...
                        <div class="section-content">
                            <form class="signup-box" method="POST" enctype="multipart/form-data">
                                ...
                                if (isset($_GET['success'])) {
                                    echo '
                                        <div class="header-error-message">
                                            <p>Consulting added successful</p>
                                        </div>
                                    ';
                                }
                                ?>
                                ...
                                <div class="signup-input one">
                                    <input type="submit" value="Add Consulting" name="add_consulting">
                                </div>
                            </form>
                        </div>
                    </div>

...
if (isset($_POST["message_send"])) {
    ...
    if (empty($firstName)) {
        ...
        $stmt = mysqli_prepare($conn, "INSERT INTO `message`(`user_id`, `first_name`, `last_name`, `subject`, `message`, `data`)   VALUES (?, ?, ?, ?, ?, ?)");

        if ($stmt) {
            mysqli_stmt_bind_param($stmt, "ssssss", $userId, $firstName, $lastName, $subject, $message, $date);

            if (mysqli_stmt_execute($stmt)) {
                header("location:send-message.php?success");
            }
...
<head>
    ...
    <link rel="stylesheet" href="style/send-message.css">
                        ...
                        <div class="contact">
                            <div class="contact-content-1">
                                <div class="section-header-content">
                                    ...
                                    <h3>Message</h3>
                                    <h1>Send message and inquiries to field officer</h1>
                                </div>
                                <div class="contact-location revealLeftToRight reveal">
                                    ...
                                    <div class="message-p">
                                        <p>On our Message page, we provide a direct line of communication between you
                                            and the Department of Agriculture (Field Officer). We understand that your
                                            questions, concerns, and feedback are valuable in shaping the future of
                                            sustainable agriculture in Sri Lanka. Whether you're a farmer seeking
                                            advice, a stakeholder with inquiries, or a supporter of eco-friendly
                                            farming, this platform is designed to facilitate open and transparent
                                            dialogue. Our dedicated team is here to listen, respond, and collaborate
                                            with you on matters related to agricultural practices, green initiatives,
                                            and more. Feel free to reach out to us, and together, we can nurture a
                                            thriving agricultural community and a greener tomorrow.
